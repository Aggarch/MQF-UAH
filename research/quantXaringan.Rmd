---
title: "CIIF"
subtitle: "⚔<br/><br/>Centro de Inteligencia e Innovación de Finsocial"
author: "Analitíca, Proyectos & Comercial"
institute: ""
date: "(`r Sys.Date()`)"
output:
  xaringan::moon_reader:
    layout: true
    background-image: url(/logo_reducido.png)
    background-size: cover
    css: [styles.css,metropolis, metropolis-fonts]
    background-color: #2d3196
    lib_dir: libs
    nature:
      highlightStyle: duo(primary_color = "#1F4257", secondary_color = "#F97B64")
      highlightLines: true
      countIncrementalSlides: false
---

{r, out.width='25%', fig.align='center', fig.cap='CIIF Logo'}
knitr::include_graphics('file://C:/Users/ANALITICA/Desktop/AG/xaringan/Recurso.svg')
...
z- Click the `Knit` button to compile it;
